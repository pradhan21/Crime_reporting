        ...
        <div class="col-md-4 mb-3">
          ...
          <div class="card mt-3 ">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap" style="background-color:#191c24">
                <h6 class="mb-0" style="COLOR:white"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="row gutters-sm">
            <div class="col-sm-6 mb-3">
              <div class="card h-100">
                <div class="card-body" style="background-color:#191c24">
                  <h6 class="d-flex align-items-center mb-3" style="color:white"><i class="material-icons text-info mr-2">assignment</i>Project Status</h6>
