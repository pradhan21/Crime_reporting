...
if (isset($_POST['upload'])) {
   ...
   echo "<script>alert('Sorry, ononly JPG, JPEG, PNG & GIF files are allowed.')</script>";
    ...
    $sql_2="INSERT INTO police_registration (image) VALUES ('$filename') where police_id='$id'";
    // Execute query+
    ...
    ?>
    <a href =""><script>alert("press here to get redirected")</script><?php header('Location:http://localhost/crime_reporting/dashboard%20user/profile.php')?></a>
    <?php
    } else {
              ...
              <div class="d-flex flex-column align-items-center text-center">
                ...
                <form method="POST" action="" enctype="multipart/form-data" >
                  <div class="profile-pic" >
                    ...
                    <img src="http://localhost/crime_reporting/dashboard%20admin(police)/image/<?php echo $image1;?>" id="output" width="200"
