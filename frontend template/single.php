            ...
            <div class="row blog-entries element-animate">
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="post-content-body">
                        ...
                        <!-- Titles -->
                        <h2 class="mb-3" style = "text-align: left; letter-spacing:2px; width: 86%; font-family: "Times New Roman", Times, serif;"><strong><?php echo $s['title']; ?></strong></h2>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item <?=$actives ; ?>">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title"><a class="text-dark" href="single.php?b_id=<?php echo $d['blog_id'];?>"><strong> <?php echo $d['title']; ?> </strong> </a></h5>
