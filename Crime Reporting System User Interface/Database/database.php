...
$sql_admin = "CREATE TABLE Admin (
    ...
    $sql_crimes = "CREATE TABLE Crimes (
        crime_id  AUTO_INCREMENT PRIMARY KEY,
        complaint_id int(10) FOREIGN KEY REFERENCES User_Complaint(complaint_id),
        user_id int(10) FOREIGN KEY REFERENCES User(user_id),
        admin_id int(10) FOREIGN KEY REFERENCES User(admin_id),
        crime_place varchar(50) NOT NULL,  
        crime_type varchar(50) NOT NULL,
        crime_evidence varchar(50) NOT NULL,
        image longblob NOT NULL,
        missing_id int(10) FOREIGN KEY REFERENCES Missing_Details(missing_id),
        sms_mobile_no int(10) FOREIGN KEY REFERENCES SMS(sms_mobile_no),
        criminal_name varchar(50) FOREIGN KEY REFERENCES Criminal_Details(criminal_name)
        )";
    ...
    $sql_investigation = "CREATE TABLE Investigation (
        ...
        crime_id int(10) FOREIGN KEY REFERENCES Crimes(crime_id),
        complaint_id int(10) FOREIGN KEY REFERENCES User_Complaint(complaint_id),
        criminal_name varchar(50) FOREIGN KEY REFERENCES Criminal_Details(criminal_name),
        station_id int(10) FOREIGN KEY REFERENCES Police_Station(station_id),
        investigation_del_id int(10) FOREIGN KEY REFERENCES Investigation_Details(investigation_del_id)
    ...
    $sql_investigation_del = "CREATE TABLE Investigation_Details (
        ...
        police_id int(10) FOREIGN KEY REFERENCES Police_Registration(police_id)
        )";
